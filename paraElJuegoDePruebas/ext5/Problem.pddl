(define (problem menus)
	...
	(tipoS Pastel_de_patata Pescado)
		...
		(= (Pprice Lentejas) 500)
		(= (Pprice Garbanzos) 400)
		(= (Pprice Paella) 500)
		(= (Pprice Sopa_de_bambu) 300)
		(= (Pprice Entremeses) 450)
		(= (Pprice Sopa) 400)
		(= (Pprice Pure) 300)
		(= (Pprice Ensalada) 320)
		(= (Pprice Ensaladilla) 350)
		(= (Pprice Calabacines_rellenos) 400)
		
		(= (Sprice Fricando) 600)
		(= (Sprice Cordero_con_patatas) 700)
		(= (Sprice Canelones) 700)
		(= (Sprice Pollo_ast) 550)
		(= (Sprice Pastel_de_patata) 630)
		(= (Sprice Pizza) 650)
		(= (Sprice Pollo) 550)
		(= (Sprice Merluza) 430)
		(= (Sprice Espagueti) 700)
		(= (Sprice Callos) 750)
	)
